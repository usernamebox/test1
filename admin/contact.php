...
elseif($_GET['act'] == "save")
{
	...
	$db->update("update about set content='".$content."' where id=2");  
	Error("编辑联系我们成功！","contact.php?act=list");
    exit;
}
?>
</body>
