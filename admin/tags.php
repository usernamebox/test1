...
<table width="98%" align="center" border="1" cellspacing="0" cellpadding="4" class="lanyubk" style="border-collapse: collapse">
  <tr class="lanyuss">
    <td height="20"  colspan="3">关键字列表</td>
  </tr>
  <tr class="lanyuds">
    <td height="23"  width="11%"><div align="center">ID</div></td>
    <td height="23"><div align="center">关键字</div>      </td>
...
?>
  <tr class="lanyuds">
    ...
    <td width="17%"><div align="center"><a href="tags.php?id=<?=$row[id]?>&act=del" onClick="{if(confirm('确定要删除吗？\n\n删除之后就无法还原!')){return true;}return false;}">删除</a>&nbsp;&nbsp;<a href="tags.php?id=<?=$row[id]?>&act=edit">修改</a></div></td>
  </tr>
<?php
}
?>  
...
<form action="tags.php?act=addok" method="post" name="form1" onSubmit="return doCheck();">
  <table width="98%" align="center" border="1" cellspacing="0" cellpadding="4" class="lanyubk" style="border-collapse: collapse">
    <tr class="lanyuss">
      <td height="20"  colspan="2">新增关键字</td>
    </tr>
    <tr class="lanyuds">
      <td height="23"  width="12%" align="right"><font color="#FF0000">*</font>关键字:</td>
...
<form action="tags.php?act=editok" method="post" name="form1" onSubmit="return doCheck();">
  <table width="98%" align="center" border="1" cellspacing="0" cellpadding="4" class="lanyubk" style="border-collapse: collapse">
    <tr class="lanyuss">
      <td height="20"  colspan="2">修改关键字</td>
    </tr>
    <tr class="lanyuds">
      <td height="23"  width="12%" align="right"><font color="#FF0000">*</font>关键字:</td>
    ...
    <tr class="lanyuqs">
      <td height="23" align="right" colspan="2"><p align="center">
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <input type="reset" name="Submit2" value="取消" onclick="document.location.href='tags.php?act=list';">
        </p></td>
    </tr>
  </table>
</form>
...
elseif($_GET['act'] == "editok")
{
	...
	if(empty($title))
	{
		Error("关键字！","tags.php?act=list");
	}
	$db->update("update tags set title='".$title."' where id='".$_POST['id']."'");  
	Error("修改成功！","tags.php?act=list");
    exit;
}
//删除部分
elseif($_GET['act'] == "del")
{
	...
	Error("删除关键字成功！","tags.php?act=list");
    exit;
}
?>
</body>
