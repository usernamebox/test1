...
<title><?php echo $show[title];?>_母校新闻_课程网站</title>
<meta name="keywords" content="<?php echo $show[title];?>,母校新闻,课程网站" />
<meta name="description" content="<?php echo $show[title];?>,母校新闻,课程网站" />
              ...
              <tr>
                <td width="571" height="29" background="images/inner-img2.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font">
                    <tr>
                      ...
                      <td>您的当前位置：<a href="index.php">首页</a> &gt;&gt; <a href="news.php">母校新闻</a> &gt;&gt; <?php echo $show[title];?></td>
                    </tr>
                  </table></td>
              </tr>
            </table>
                    ...
                    <tr>
                      <td height="257" valign="top"><table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <table width="571" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="50"><div align="center" class="fy">【<a href="shownews.php?id=<?=$show[id]?>&act=show">推荐新闻</a>】&nbsp;【<a href="mailto:<?=$sitemail?>">我要纠错</a>】&nbsp;【<a href="javascript:window.print()">打印</a>】&nbsp;【<a href="javascript:window.close()">关闭</a>】</div></td>
                          </tr>
                        </table>
						<table width="571" border="0" cellspacing="0" cellpadding="0">
                          <tr>
