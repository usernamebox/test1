...
if($result=$db->getfirst("select * from news where istop=1 order by id desc"))
{
$total=$total-1;
}
//页码计算
...
<title>课程网站</title>
<meta name="keywords" content="母校新闻,课程网站" />
<meta name="description" content="母校新闻,课程网站" />
              ...
              <tr>
                <td width="571" height="29" background="images/inner-img2.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font">
                    <tr>
                      ...
                      <td>您的当前位置：<a href="index.php">首页</a> &gt;&gt; <a href="news.php">相关新闻</a></td>
                    </tr>
                  </table></td>
              </tr>
            </table>
                    ...
                    <tr>
                      <td height="28"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menu">
                          <tr>
                            ...
                            <td width="130"><span class="STYLE2">相关新闻</span></td>
...
{
echo "·<a href=shownews.php?id=".$result[id].">".$result[title]."</a><br />";
}
else
{
?>
                        ...
                        <tr>
                          ...
                          <td class="font" style="padding-right:18px;"><span class="STYLE4">最新新闻：</span><a href="shownews.php?id=<?php echo $result[id]; ?>"><?=$result['title']?></a>[<?=$result['ntime']?>]<br />
                            <a href="shownews.php?id=<?php echo $result[id]; ?>"><span class="STYLE6">[详细查看]</span></a></td>
                        </tr>
                      </table>
<?php
}
...
{
$result=$db->query("select * from news where id <>$topid order by id desc limit $offset,$num");
}
while($row=$db->getarray($result)){
?>
                        ·<a href="shownews.php?id=<?php echo $row[id]; ?>"><?php echo $row[title]; ?></a><br />
                        <?php
}
?>
</td>
