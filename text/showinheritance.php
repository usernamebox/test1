...
{
$id=$_GET["id"];
$teachedit=$db->query("select * from inheritance where id='$id'");
//mysql_query("set names 'gb2312'");//这就是指定数据库字符集，一般放在连接数据库后面就系了
$show=$db->getarray($teachedit);
$hits=$show[hits]+1;
$db->update("update inheritance set hits='$hits' where id='$id'");
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312" />
<title><?php echo $show[title];?>_传承_课程网站</title>
<meta name="keywords" content="<?php echo $show[title];?>,传承,课程网站" />
<meta name="description" content="<?php echo $show[title];?>,传承,课程网站" />
              ...
              <tr>
                <td width="571" height="29" background="images/inner-img2.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font">
                    <tr>
                      ...
                      <td>您的当前位置：<a href="index.php">首页</a> &gt;&gt; <a href="inheritance.php">传承</a> &gt;&gt; <?php                   if($show[cat]==1)
				  {
				    echo "<a href='inheritance.php?cat=1'>人生导师</a>";
				   }
				  elseif($show[cat]==2)
				  {
				    echo "<a href='inheritance.php?cat=2'>创业导航</a>";
				   }
				   ?> &gt;&gt; <?=$show[title]?></td>
                    </tr>
                  </table></td>
                ...
                <td width="571" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td valign="top"><table cellspacing="0" cellpadding="0" width="100%">
                          ...
                          <tr>
                            <td align="middle" bgcolor="#efefef" height="24" class="font"><div align="center">发布人：<?php echo $show[author];?>　   供稿者：<?php echo $show[show];?>　 　　更新日期：<?php echo $show[ntime];?>　   浏览：<?php echo $show[hits];?>　   推荐：<?php echo $show[times];?>　   〖<a href="upfile.php">我要申请</a>〗</div></td>
                          </tr>
                          <tr>
					...
					<td valign="bottom"><table width="571" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="50"><div align="center" class="fy">【<a href="showinheritance.php?id=<?=$show[id]?>&act=show">推荐新闻</a>】&nbsp;【<a href="mailto:<?=$sitemail?>">我要纠错</a>】&nbsp;【<a href="javascript:window.print()">打印</a>】&nbsp;【<a href="javascript:window.close()">关闭</a>】</div></td>
                          </tr>
                      </table></td></tr>
                </table></td>
              </tr>
...
elseif($_GET['act']=="show")
{
	...
	$id=$_GET["id"];
	$db->update("update `inheritance` set `times`=`times`+1 where `id`='$id'");
