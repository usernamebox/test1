...
<title><?php echo $show[title];?>_活动_课程网站</title>
<meta name="keywords" content="<?php echo $show[title];?>,活动,课程网站" />
<meta name="description" content="<?php echo $show[title];?>,活动,课程网站" />
              ...
              <tr>
                <td width="571" height="29" background="images/inner-img2.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font">
                    <tr>
                      ...
                      <td>您的当前位置：<a href="index.php">首页</a> &gt;&gt; <a href="active.php">活动</a> &gt;&gt; <?php                   if($show[cat]==1)
				  {
				    echo "<a href='active.php?cat=1'>讲坛</a>";
				   }
				  elseif($show[cat]==2)
				  {
				    echo "<a href='active.php?cat=2'>对话</a>";
				   }
				  elseif($show[cat]==3)
				  {
				    echo "<a href='active.php?cat=3'>沙龙</a>";
				   }
				  elseif($show[cat]==4)
				  {
				    echo "<a href='active.php?cat=4'>年会</a>";
				   }
				   ?> &gt;&gt; <?=$show[title]?></td>
                    </tr>
                  </table></td>
                    ...
                    <tr>
                      <td height="257" valign="top"><table cellspacing="0" cellpadding="0" width="100%">
                        ...
                        <table width="571" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="50"><div align="center" class="fy">【<a href="showactive.php?id=<?=$show[id]?>&act=show">推荐新闻</a>】&nbsp;【<a href="mailto:<?=$sitemail?>">我要纠错</a>】&nbsp;【<a href="javascript:window.print()">打印</a>】&nbsp;【<a href="javascript:window.close()">关闭</a>】</div></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table></td>
